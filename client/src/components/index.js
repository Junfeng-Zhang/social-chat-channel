/* export all the components automatically
these components are being exported straight from the components folder, and inside
then we don't need to add any file names because everything is being exported
*/ 
